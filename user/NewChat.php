...
<form id="new_chat" role="form" enctype="multipart/form-data">
         ...
         <!--     <p>Try the keyboard navigation by clicking arrow left or right!</p> -->
                ...
                <input class="form-control" onblur="check_recipient(this.value)" name="recipient" placeholder="Enter recipient email" type="text">
		  ...
		  <button id="btnSubmit" type="submit" class="btn btn-info btn-block">Start Chat</button></form>
