  ...
  <div class="sl-mainpanel">
     <nav class="breadcrumb sl-breadcrumb">
	  ...
	  <div class="card pd-20 pd-sm-40">
		  ...
		  <tr>
<?php
$q3 = mysqli_query($con,"SELECT * FROM $activity_table WHERE userID='$managerID' and addDate>=(select lastLogin from $user_table where ID='$managerID') order by activityID desc LIMIT 5");
