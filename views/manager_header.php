...
$u2 = mysqli_query($con,"UPDATE $user_table SET last_seen=NOW(), last_url = '$lasturl' WHERE ID = '$ID'");
$u1 = mysqli_query($con,"SELECT * FROM $user_table WHERE ID = '$ID'");
$user = mysqli_fetch_assoc($u1);
}
?>
<!DOCTYPE html>
<html lang="en">
  <head>
    ...
    <title><?php echo $page_name." | User Panel | ".$option['website_name']; ?></title>
        ...
        <nav class="nav">
          <div class="dropdown">
            <a class="nav-link nav-link-profile" data-toggle="dropdown">
              <span class="logged-name"><?php echo $user['full_name']; ?></span>
              <img src="<?php echo $user['photo']; ?>" class="wd-32 rounded-circle">
            </a>
